...
public class ImageController {
	...
	public ResponseEntity<?> addImage(HttpServletRequest request,@RequestParam("image") MultipartFile image, @PathVariable Long productId) {
		try {
...
//
//	@PostMapping("/products/add/image/{productId}")
//	public String testMethod(@PathVariable Long productId) {
//		return "hdsfjhdsjfkdsfhjks";
//	}
//	
