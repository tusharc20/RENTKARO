...
//		userObj.addOwnProduct(productObj);
		...
		Product tempProduct= productRepo.save(productObj);
...
//		return new MyProductDTO(productOBJ.getProductId(),productOBJ.getOwner().getId(),productOBJ.getProductName(),productOBJ.getProductDescription(),productOBJ.getProductFeatures(),productOBJ.getRentalPrice(),productOBJ.getDeposite(),productOBJ.getCategory(),productOBJ.getRating(),null,productOBJ.getProductComplain());
		return null;
	}
...
//		userObj.setRentedProduct(productOBJ);
		OrderHistory obj = new OrderHistory(productOBJ.getProductName(),productOBJ.getProductDescription(),productOBJ.getProductFeatures(),productOBJ.getRentalPrice(),productOBJ.getDeposite(),LocalDate.now(),null,null,productOBJ.getRating());
