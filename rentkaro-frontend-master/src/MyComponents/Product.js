                            ...
                            <div className="row g-0">
                                    ...
                                    <div className="bg-image hover-zoom ripple rounded ripple-surface me-md-3 mb-3 mb-md-0">
                                        ...
                                        {(() => {
                                            if (window.location.pathname == "/myproducts") {
                                                return (
                                                <a href="" onClick={(e) => { e.preventDefault(); navigate("/product?prodid=" + index) }}>
                                ...
                                <div className="col-xl-6 col-md-5 col-sm-7 ">
                                    ...
                                    <p className="text mb-4 mb-md-0 w-100">
                                        ...
                                        <br /> Features : <br />{product.productFeatures}
                                    </p>
                                </div>
                                <div className="col-xl-3 col-md-3 col-sm-5 p-2">
                                    ...
                                    {(() => {
                                        if (window.location.pathname == "/myproducts") {
                                            return (
                                                <div className="mt-4">
                                                    <a href="" onClick={(e) => { e.preventDefault(); navigate("/updateprod?prodid" + product.productId) }} className="btn btn-primary shadow-0 m-1" type="button">Edit</a>
                                                    <a href="" onClick={(e) => { e.preventDefault(); deleteProd(index) }} className="btn btn-danger shadow-0 m-1" type="button">Delete</a>
                                                </div>
                                            )
