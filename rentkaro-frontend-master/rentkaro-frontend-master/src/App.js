  ...
  return (
    <Router>
      ...
      <Route exact path="/" element={
        <div className='App'>
          <div className="row align-items-center" style={{ height: 100 + 'vh' }}><div className="mx-auto col-10 col-md-8 col-lg-6">
            <LoginHeader />
            <div className="tab-content">
              <Login favIcons={["facebook-f", "google", "twitter", "github"]} />
              <Register />
            </div>
          </div>
          </div>
