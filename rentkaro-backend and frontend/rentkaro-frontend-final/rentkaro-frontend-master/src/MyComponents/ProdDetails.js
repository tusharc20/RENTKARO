...
function ProdDetails(props) {
    ...
    const loadProducts = async () => {
        ...
        await axios.get("http://localhost:8080/product/" + prodid, { withCredentials: true }).then((resp) => {
            ...
            axios.get("http://localhost:8080/product/prodimage?prodid=" + prodid).then((resp) => {
                                    ...
                                    if (product.ownerId == null) {
                                        return (
                                            <div className="d-flex align-items-end pt-3 px-0 pb-0 mt-auto row">
                                                <a href="" onClick={(e) => { e.preventDefault(); rentProd(product) }} className="btn col-9 btn-primary shadow-0">Rent</a>
                                                <div className="col-1" />
                                        ...
                                        return (
                                            <div className="d-flex align-items-end pt-3 px-0 pb-0 mt-auto row">
                                                <a href="" onClick={(e) => { e.preventDefault(); navigate("/updateprod?prodid=" + prodid) }} className="btn col-5 btn-primary shadow-0">Edit</a>
                                                <div className="col-2" />
